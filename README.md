...
Rank-based recommendation (popularity)
User-User similarity collaborative filtering (baseline + optimized)
Item-Item similarity collaborative filtering (baseline + optimized)
SVD Matrix Factorization (baseline + optimized)
